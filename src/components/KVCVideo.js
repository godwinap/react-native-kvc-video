...
import { StyleSheet, requireNativeComponent, NativeModules, View, ViewPropTypes, Image, Platform, findNodeHandle, processColor } from 'react-native';
...
export default class Video extends Component {
  ...
  render() {
    ...
    const RCTVideoInstance = this.getViewManagerConfig('KVCVideo');
    ...
    Object.assign(nativeProps, {
      ...
      rewindBtnImg: resolveAssetSource(this.props.rewindBtnImg),
      forwardBtnImg: resolveAssetSource(this.props.forwardBtnImg),
      seekbarCursorImg: resolveAssetSource(this.props.seekbarCursorImg),
      rewindAndForwardInterval: this.props.rewindAndForwardInterval,
      seekbarCursorActiveImg: resolveAssetSource(this.props.seekbarCursorActiveImg),
      seekbarMaxTint: processColor(this.props.seekbarMaxTint),
      seekbarMinTint: processColor(this.props.seekbarMinTint),
      fullscreenImg:resolveAssetSource(this.props.fullscreenImg)
    });
    ...
    return (
      <React.Fragment>
        <KVCVideo ref={this._assignRoot} {...nativeProps} />
        {this.props.poster &&
...
const KVCVideo = requireNativeComponent('KVCVideo', Video, {
  nativeOnly: {
    src: true,
    seek: true,
    fullscreen: true,
